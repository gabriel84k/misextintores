            ...
            <table class="table table-borderless">
                <thead >
                    <tr class="text-center">
                        <th colspan="2" scope="col" style=" width: 150px;"><h4>INSPECCION KIT DE DERRAME</h4></th>
            ...
            <table class="text-center">
                <thead class="cabeza">
                    <tr class="wid">
                        ...
                        <th>Gramilla Absorbente</th>
                        <th>Tiene ID Equipo</th>

                        <th>Tiene Bolsa Amarilla </th>
                        <th>Tiene Mameluco Tyvex</th>
                        <th>Tiene Antiparra</th>

                        <th>TieneGuantes</th>
                        <th>Tiene Caja Amarilla Chica</th>
                        <th>Tiene Caja Amarilla Grande</th>
                        
                        <th>Tiene Cordones Absorbentes</th>
                        <th>Tiene VRM</th>
                ...
                <tbody class="cuerpo">
                    ...
                    @foreach($datos as $item)
                            ...
                            <tr class={{$trestado}} style="text-align: center;">
                                ...
                                <td style="width: 1px">{{$item->puesto->kitegusur->codigoElemento}}</td>
                                <td style="width: 1px">{{$item->puesto->kitegusur->modelo }}</td>
                                ...
                                @if ($item->DetalleInspeccion->gramillaAbsorbente!=0)
                                    <td style="width: 1px">Si</td>
                                @else
                                    <td style="width: 1px">No</td>
                                @endif
                                
                                @if ($item->DetalleInspeccion->tieneIDEquipo!=0)
                                    <td style="width: 1px">Si</td>
                                @else
                                    <td style="width: 1px">No</td>
                                @endif

                                @if ($item->DetalleInspeccion->tieneBolsaAmarilla!=0)
                                    <td style="width: 1px">Si</td>
                                @else
                                    <td style="width: 1px">No</td>
                                @endif
                                ...
                                @if ($item->DetalleInspeccion->tieneAntiparra!=0)
                                    <td style="width: 1px">Si</td>
                                @else
                                    <td style="width: 1px">No</td>
                                @endif
                                
                                @if ($item->DetalleInspeccion->tieneGuantes!=0)
                                    <td style="width: 1px">Si</td>
                                @else
                                    <td style="width: 1px">No</td>
                                @endif
                            
                                @if ($item->DetalleInspeccion->tieneCajaAmarillaChica!=0)
                                    <td style="width: 1px">Si</td>
                                @else
                                    <td style="width: 1px">No</td>
                                @endif
                                
                                @if ($item->DetalleInspeccion->tieneCajaAmarillaGrande!=0)
                                    <td style="width: 1px">Si</td>
                                @else
                                    <td style="width: 1px">No</td>
                                @endif
                        
                                @if ($item->DetalleInspeccion->tieneCordonesAbsorbentes!=0)
                                    <td style="width: 1px">Si</td>
                                @else
                                    <td style="width: 1px">No</td>
                                @endif
                            
                                @if ($item->DetalleInspeccion->tieneVRM!=0)
                                    <td style="width: 1px">Si</td>
                                @else
                                    <td style="width: 1px">No</td>
                                @endif
