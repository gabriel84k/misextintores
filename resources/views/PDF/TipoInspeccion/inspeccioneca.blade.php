            ...
            <table class="table table-borderless">
                <thead >
                    <tr class="text-center">
                        <th colspan="2" scope="col" style=" width: 150px;"><h4>INSPECCION ECA</h4></th>
                ...
                <tbody class="cuerpo">
                    ...
                    @foreach($datos as $item)
                            ...
                            <tr class={{$trestado}} style="text-align: center;">
                                ...
                                <td style="width: 1px">{{$item->puesto->ecasegusur->codigoElemento}}</td>
                                
                               
                                @if ($item->DetalleInspeccion->campana!=0)
                                ...
                                @if ($item->DetalleInspeccion->valvula_purga!=0)
                                    <td style="width: 1px">Si</td>
                                @else
                                    <td style="width: 1px">No</td>
                                @endif

                                @if ($item->DetalleInspeccion->manometro!=0)
                                    <td style="width: 1px">Si</td>
                                @else
                                    <td style="width: 1px">No</td>
                                @endif
