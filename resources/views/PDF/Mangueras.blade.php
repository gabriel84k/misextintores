        ...
        <div class="container-lg">
            ...
            <table class="table table-borderless">
                <thead >
                    <tr class="text-center">
                        ...
                        <th  scope="col">
                            <h5 style="font-size: 14px;">REPORTE DE MANGUERAS</h5>
                        </th>
                        <th scope="col"> 
            ...
            <table class="table text-center">
                ...
                <tbody class="cuerpo">
                    ...
                    {{  $PHaño=date_format(date_create($item->vencimientoDePH),"Y")}}
                    {{  $PHmes=date_format(date_create($item->vencimientoDePH),"m")}}
                    
                        @if (($año >= $PHaño && $PHmes < $mes) || ($PHaño < $año))
                            <tr style="background-color: rgb(218, 160, 160);">
                                <td>{{$item->numeroManguera}}</td>
                                <td>{{$item->longitudmili}}</td>
                                <td>{{round($item->diametromili,1)}}  mm</td>
                                <td>{{$item->uniones}}</td>
                                <td>{{$item->lanzanombre}}</td>
                                <td>{{$item->boquillanombre}}</td>
                                <td>{{$PHmes.'/'.$PHaño}}</td>
